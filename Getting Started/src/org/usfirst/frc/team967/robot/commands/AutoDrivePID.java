...
public class AutoDrivePID extends Command {
    ...
    protected void execute() {
    	...
    	SmartDashboard.putNumber("Show kp", kp);
    	SmartDashboard.putNumber("Show ki", ki);
    	SmartDashboard.putNumber("Show kd", kd);
    	SmartDashboard.putNumber("P out", Pout);
    	SmartDashboard.putNumber("I out", Iout);
    	SmartDashboard.putNumber("D out", Dout);
    	SmartDashboard.putNumber("mapValue", map(Pout+Iout, -threshold, threshold, -1, 1));
    	SmartDashboard.putNumber("mapValue2", map(200, -threshold, threshold, -1, 1));
